                        ...
                        <div class="card">
                            ...
                            <div class="card-body" style="margin-top: -2%">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-9">
                                        <select name="brand_id" id="" class="selectpicker form-control @error('brand_id') is-invalid @enderror" data-live-search="true" multiple>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body" style="margin-top: -2%">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control date" name="discount_date_range" id="singledaterange" data-toggle="date-picker" data-cancel-class="btn-warning" required>
                                        @error('description')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
