                ...
                <div class="card-body">
                    <ul class="nav nav-tabs nav-fill border-primary mb-3">
                        @foreach (\App\Models\Language::all() as $key => $language)
                            <li class="nav-item">
                                <a class="nav-link text-reset @if ($language->code == $lang) active @else bg-light border-light border-left-0 @endif py-3" href="{{ route('brand.edit', ['id'=>$brand->id, 'lang'=> $language->code] ) }}">
