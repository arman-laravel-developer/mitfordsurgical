            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-3">
                        <form action="{{route('seller.report.category-wise-stock')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <a href="{{route('seller.report.products-stock')}}" class="btn btn-danger">Reset</a>
                                    <div class="btn-group">
                        ...
                        <form action="{{ route('seller.export.products-category-wise') }}" method="GET" id="categoryWise">
