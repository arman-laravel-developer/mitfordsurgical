                ...
                <div class="row">
                    <div class="col-12">
                        <div class="breadcrumb-contain">
                            <h2>{{translate('Seller Dashboard')}}</h2>
                            <nav>
                                <ol class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item active">{{translate('Seller Dashboard')}}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                ...
                                <div class="profile-contain">
                                    <div class="profile-image">
                                        <div class="position-relative">
                                            <img src="{{ asset('/') }}front/assets/images/vendor-page/logo.png"
                                    ...
                                    <div class="product-tab">
                                        ...
                                        <div class="table-responsive dashboard-bg-box">
                                            <table class="table product-table">
                                                ...
                                                <tr>
                                                    <td class="product-image">
                                                        <img src="{{ asset('/') }}front/assets/images/vegetable/product/7.png"
                                                             class="img-fluid" alt="">
                                                    </td>
                                                    <td>
